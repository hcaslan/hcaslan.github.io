                ...
                <Box sx={{ padding: 4 }}>
                    <Grid container spacing={4}>
                        <Grid item xs={12} md={8}>
                            ...
                            <Typography variant="body1" gutterBottom>
                                I graduated from the Department of Electrical and Electronics Engineering in 2022. After that, I developed small-scale desktop applications using C++ and Qt. I then enrolled in a full-stack development course with Java, which I completed in July 2024. Currently, I am pursuing a Master's in Computer Engineering.
                            </Typography>
                            <Typography variant="body1" gutterBottom>
